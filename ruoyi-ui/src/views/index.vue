  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24" style="padding-left: 20px">
        <h2>基于计算机图像检测与大模型反馈的课堂行为系统</h2>
        <p>
          本系统结合计算机视觉技术（YOLO/RT-DETR）与大语言模型（Deepseek/通义千问），实现课堂行为自动识别、智能分析与反馈。系统支持图片检测、视频检测、实时摄像头检测三种模式，能够识别9种常见课堂行为，并通过AI模型提供智能教学建议，帮助教师更好地了解学生的课堂状态。
        </p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="success">🎓 课堂行为智能分析</el-tag>
          <el-tag type="primary" style="margin-left: 10px">🤖 AI驱动</el-tag>
          <el-tag type="warning" style="margin-left: 10px">📊 数据可视化</el-tag>
        </p>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="24" :lg="24">
        <el-card class="update-log">
          ...
          <el-collapse accordion style="max-height: 600px; overflow-y: auto;">
